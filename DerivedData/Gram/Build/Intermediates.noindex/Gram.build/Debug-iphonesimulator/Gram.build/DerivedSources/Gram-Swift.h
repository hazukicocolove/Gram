...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Gram",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Gram11AppDelegate")
...
SWIFT_CLASS("_TtC4Gram13SceneDelegate")
...
SWIFT_CLASS("_TtC4Gram14ViewController")
@interface ViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified cameraImageView;
- (void)viewDidLoad;
- (IBAction)takePhoto;
- (IBAction)savePhoto;
- (IBAction)colorFilter;
- (IBAction)openAlbum;
- (IBAction)snsPhoto;
